 ...
 *
 * Security: the worker-level Basic Auth gate + CSRF check (Sec-Fetch-Site)
 * in workers/app.ts protect this endpoint. processUploadedPdf adds magic-byte
 * verification + filename sanitization.
 */
